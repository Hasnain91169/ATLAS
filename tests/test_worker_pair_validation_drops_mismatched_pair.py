                ...
                "proposed_actions": [
                    {
                        ...
                        "payload": {"list_id": "list-2", "task_id": "task-1"},
                        "reason": "Quick win.",
                    }
                ],
                "confidence": 0.7,
...
def test_worker_pair_validation_drops_mismatched_pair():
    ...
    assert any("pair not in context" in item for item in result.uncertainties)
